...
### NOTES: 
In **#OOBToDo 008** through **#OOBToDo 011** you will implement the client side.  
The Example Plugin provides example use cases of using the **generic** RPC provided by the grpc-template, and those example requests are the ones associated with the "Double" and "String" Measurement UI controls.  
