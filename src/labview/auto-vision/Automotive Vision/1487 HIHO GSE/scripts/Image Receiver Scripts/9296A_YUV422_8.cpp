...
0x04, 0x90, 0x00, 0x01, 0x02, //set 9296A to 6Gbps Mode, 0x01 is 3Gbps, 0x02 is 6Gbps
...
////////////////////////////////////////////////////////////////////////////////////////////////////
0x04, 0x90, 0x02, 0xC6, 0x02, // GPIO7 source for GMSL2 transmission ID:2
0x04, 0x90, 0x02, 0xC5, 0x23, // GPIO7 enable transmission 
...
0x04, 0x90, 0x03, 0x1D, 0x0C, // MIPI clock rate - 1.2Gbps from controller 0 clock (Port A slave in 2x1x4 mode)
0x04, 0x90, 0x03, 0x20, 0x0C, // MIPI clock rate - 1.2Gbps from controller 1 clock (Port A master in 2x1x4 mode)
0x04, 0x90, 0x03, 0x23, 0x0C, // MIPI clock rate - 1.2Gbps from controller 2 clock (Port B master in 2x1x4 mode)
0x04, 0x90, 0x03, 0x26, 0x0C, // MIPI clock rate - 1.2Gbps from controller 2 clock (Port B slave in 2x1x4 mode)

////////////////////////////////////////////////////////////////////////////////////////////////////
// Perform 1:1 mapping from Stream ID 0, 1, 2, 3 to pipeline X, Y, Z, U
////////////////////////////////////////////////////////////////////////////////////////////////////
0x04, 0x90, 0x00, 0x50, 0x02, // Route data from stream ID 2 to pipe X
0x04, 0x90, 0x00, 0x51, 0x01, // Route data from stream ID 1 to pipe Y
0x04, 0x90, 0x00, 0x52, 0x00, // Route data from stream ID 0 to pipe Z
0x04, 0x90, 0x00, 0x53, 0x03, // Route data from stream ID 3 to pipe U

// ////////////////////////////////////////////////////////////////////////////////////////////////////
// // Configure local deserializer to receive data from Pipe X. Forward data type 0x1E to PortB
// ////////////////////////////////////////////////////////////////////////////////////////////////////
0x04, 0x90, 0x04, 0x0B, 0x0F, // Enable first 4 mappings for Pipe X (up to 16 available)
0x04, 0x90, 0x04, 0x0C, 0x00, // Disable 8 last mappings for Pipe X
0x04, 0x90, 0x04, 0x2D, 0xAA, // Route Pipe X to DPHY2 which coresponds to PortB

0x04, 0x90, 0x04, 0x0D, 0x1E, // Pipe X DT and VC Source
0x04, 0x90, 0x04, 0x0E, 0x1E, // Pipe X DT and VC Destination
...
0x04, 0x90, 0x04, 0x13, 0x12, // Pipe X Embedded Source
0x04, 0x90, 0x04, 0x14, 0x12, // Pipe X Embedded Destination

////////////////////////////////////////////////////////////////////////////////////////////////////
// Enable the local deserializer PHYs
////////////////////////////////////////////////////////////////////////////////////////////////////
0x04, 0x90, 0x03, 0x32, 0xF0, // Enable port B (PHY2, PHY3).