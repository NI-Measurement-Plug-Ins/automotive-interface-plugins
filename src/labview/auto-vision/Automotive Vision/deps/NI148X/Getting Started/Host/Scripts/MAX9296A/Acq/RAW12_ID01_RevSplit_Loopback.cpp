...
// be used to configure adjacent serial inputs (e.g. SI0 and SI1) on a PXIe-1487 8 In module.
...
// Select only SIOA
////////////////////////////////////////////////////////////////////////////////////////////////////
0x04, 0x90, 0x00, 0x10, 0x21, // Apply Reset Oneshot for changes, Select SIOA
0x00, 0x80,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
0x04, 0x90, 0x00, 0x10, 0x23, // Apply Reset Oneshot for changes, Select splitter mode
0x00, 0x80,
...
0x04, 0x60, 0x03, 0x30, 0x10, // Set serializer to 1x4 mode
0x04, 0x60, 0x03, 0x33, 0x44, // Map PHY2 lane 0 to lane 0 and PHY2 lane 1 to lane 1
0x04, 0x60, 0x03, 0x31, 0x33, // Set 4 lanes for serializer.

////////////////////////////////////////////////////////////////////////////////////////////////////
// Configure remote serializer (SIOA) to transmit on Stream ID 0
////////////////////////////////////////////////////////////////////////////////////////////////////
// The below may need changed for a specific application to send data to ECU deserializer on ECU's 
// expected stream ID and data types. 
0x04, 0x60, 0x00, 0x53, 0x10, // Pipe X stream ID 0 - Pipe X is enabled in this example
0x04, 0x60, 0x00, 0x57, 0x11, // Pipe Y stream ID 1
0x04, 0x60, 0x00, 0x5B, 0x12, // Pipe Z stream ID 2
0x04, 0x60, 0x00, 0x5F, 0x13, // Pipe U stream select 3

0x04, 0x60, 0x03, 0x11, 0x10, // Start MIPI port for Pipe X
0x04, 0x60, 0x03, 0x08, 0x6F, // Enable info lines. Use Port B on all Pipes

////////////////////////////////////////////////////////////////////////////////////////////////////
// Configure remote serializer (SIOA) video pipelines
////////////////////////////////////////////////////////////////////////////////////////////////////
0x04, 0x60, 0x03, 0x14, 0x6C, // Pipe X enabled (bit 6), Route DT 0x2C to Pipe X
0x04, 0x60, 0x03, 0x15, 0x00, // No second data type selected for PipeX

0x04, 0x60, 0x03, 0x16, 0x00, // Pipe Y disabled (bit 6), No primary data type selected for Pipe Y
0x04, 0x60, 0x03, 0x17, 0x00, // No secondary data type selected for Pipe Y

0x04, 0x60, 0x03, 0x16, 0x00, // Pipe Z disabled (bit 6), No primary data type selected for Pipe Z
0x04, 0x60, 0x03, 0x17, 0x00, // No secondary data type selected for Pipe Z

0x04, 0x60, 0x03, 0x16, 0x00, // Pipe U disabled (bit 6), No primary data type selected for Pipe U
0x04, 0x60, 0x03, 0x17, 0x00, // No secondary data type selected for Pipe U

0x04, 0x60, 0x00, 0x02, 0x33, // Enable Pipeline X for video transmission.
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Configure remote serializer (SIOB) to transmit on Stream ID 1
////////////////////////////////////////////////////////////////////////////////////////////////////
// The below may need changed for a specific application to send data to ECU deserializer on ECU's 
// expected stream ID and data types. 
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Configure remote serializer (SIOB) video pipelines
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Configure local deserializer to receive data from Pipe X. Forward data type 0x2C to PortA
////////////////////////////////////////////////////////////////////////////////////////////////////
...
0x04, 0x90, 0x04, 0x2D, 0x15, // Route Pipe X to DPHY1 which coresponds to PortA
