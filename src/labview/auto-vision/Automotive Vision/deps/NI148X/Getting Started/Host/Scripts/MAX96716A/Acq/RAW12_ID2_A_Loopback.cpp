...
0x04, 0x50, 0x04, 0x74, 0x19, // Enable Tunnelling Mode with 4 lanes
0x04, 0x50, 0x04, 0xB4, 0x1F, // Enable Tunnelling Mode with 4 lanes

0x04, 0x50, 0x00, 0x10, 0x21, // Apply Reset Oneshot A for changes, select SIOB
0x00, 0x80,
0x04, 0x50, 0x00, 0x12, 0x24, // Apply Reset Oneshot B for changes, select SIOB
0x00, 0x80,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// This script makes no assumptions about what may be connected to SIOA. Explicitly selecting
// SIOA prevents any conflicts with what may be on SIOA.
...
0x04, 0x50, 0x04, 0x0A, 0xD0, // lane count - 0 - unused in 2x4 mode
...
0x04, 0x50, 0x04, 0xCA, 0xD0, // lane count - 0 - unused in 2x4 mode
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Perform 1:1 mapping from Stream ID 1, 2 to pipeline Y, Z
////////////////////////////////////////////////////////////////////////////////////////////////////
...
0x04, 0x50, 0x04, 0xAD, 0x15, // Route Pipe Z to DPHY2 which coresponds to PortA
...
0x04, 0x50, 0x04, 0x6D, 0x15, // Route Pipe Y to DPHY2 which coresponds to PortA
