...
# Active RX channels
rxChannel = [0] #The active RX port of deserializer in 4I4O module is always Port 0 only. 
...
#Enable 4I4O Tap Mode
scripts_common.enable_4I4O_des_tap_mode(board, devAddr)